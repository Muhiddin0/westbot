...
PHONE_RU = """
<b>
Пожалуйста, пришлите мне свой номер телефона,
Или написать
</b>
"""
...
COMMENT_BALL_RU = \
"""
Спасибо за выбор ресторана West
Мы будем рады, если вы поможете нам улучшить качество наших услуг.
...
If you help us improve our quality of service we would be happy.
...
ORDER_UZ = """
<b>
🙂 Categoryalardan birini tanlang
</b>
"""
...
THAKS_SERVICES = {
    'uz': "Botdan foydalanganigiz uchun rahmad",
...
🛵 Reach your products after {} Dacia
...
<b>
The fact that the products you ordered are not left saabali can not deliver the order now 😔
Dear customer❗️
</b>
"""
...
def NEW_COMMENT(**kwargs):
    ...
    new_order_message_text += f"\n\n"
    new_order_message_text += f"Baholash:  <a href='{kwargs['ball']}\n'>{kwargs['ball']}</a>\n"
    new_order_message_text += f"Fikr: <a href='{kwargs['comment']}\n'>{kwargs['comment']}</a>"
...
send in the form
or click share your phone number
"""
